  ...
  return (
    <Button
      ...
      className={cn(
        ...
        modifiers.focused && 'relative z-10 border-ring ring-ring/50 ring-[3px]',
        isSingleSelected && 'bg-primary text-primary-foreground',
        modifiers.range_middle && 'rounded-none bg-accent text-accent-foreground',
        modifiers.range_start && 'rounded-md rounded-l-md bg-primary text-primary-foreground',
        modifiers.range_end && 'rounded-md rounded-r-md bg-primary text-primary-foreground',
        defaultClassNames.day,
        className,
      )}
      {...props}
