...
export function VisualDocEditor({ content, onChange, readOnly }: VisualDocEditorProps) {
              ...
              {blocks.map((block, index) => {
                ...
                return (
                  <SortableItem key={block.id} id={block.id} className="group relative">
                    ...
                    >
                      <div className={cn(appearanceClasses.header, "rounded-t-[inherit]")}>
                        ...
                        <span className="text-[11px] text-muted-foreground">
                          {blockPresetLabels[normalizeBlockAppearance(block.appearance).preset]}
                        </span>
                    ...
                    {!readOnly && (
                      <div className="mt-1 flex justify-center -mb-1.5">
                        <AddBlockMenu
                          types={available}
...
function TextBlockEditor({
  ...
  return (
    <Textarea
      ...
      className="text-sm min-h-24 leading-relaxed"
      rows={4}
      readOnly={readOnly}
    />
  )
